...
<section>
   <div class="container-fluid py-2 w-100 ">
       ...
       <div class="text-black p-3" style="border-radius: 1rem;" >
           ...
           <div class="mb-0">
              <h2 class="fw-bold text-uppercase text-start mb-0">Update Vehcile</h2>
           </div>

           <div class="">
              <form action="{{ url('/dashboard/carManager/updateVehicle/'.$vehicle['id']) }}" method="post" class="mb-md-5 px-5 contact-form" enctype="multipart/form-data">
               @method('put')
               @csrf
                  ...
                  <div class="form-section">
                    ...
                    <div class="mt-3">
                       ...
                       <input type="text" name="carName" class="form-control rounded @error('carName') is-invalid @enderror" id="carName" required value="{{ $vehicle->carName }}" >
                    </div>
                    @error('carName')
                    ...
                    <div class="mt-3">
                       ...
                       <input type="text" name="plateNumber" class="form-control rounded @error('plateNumber') is-invalid @enderror" id="plateNumber" required value="{{ $vehicle->plateNumber }}" >
                    </div>
                    @error('plateNumber')
                       <div class="invalid-feedback">
                          {{ $message }}
                    ...
                    <div class="mt-3">
                       ...
                       <input type="number" name="price" class="form-control rounded @error('price') is-invalid @enderror" id="price" required value="{{ $vehicle->price }}" >
                    </div>
                    @error('price')
                       <div class="invalid-feedback">
                          {{ $message }}
                    ...
                    <div class="mt-3">
                       ...
                       <textarea class="form-control rounded" id="carAddress" rows="2" name="carAddress">{{ $vehicle->carAddress }}</textarea>
                    </div>
                    ...
                    <div class="d-flex flex-row justify-content-between mt-3">
                       ...
                       <div class="col-md-3">
                          ...
                          <select id="carType" name="carType" class="form-control">
                             <option selected>{{ $vehicle->carType }}</option>
                       ...
                       <div class="col-md-3">
                          ...
                          <select id="fuelType" name="fuelType" class="form-control">
                             <option selected>{{ $vehicle->fuelType }}</option>
                       ...
                       <div class="col-md-3">
                          ...
                          <select id="seat" name="seat" class="form-control">
                             <option selected>{{ $vehicle->seat }}</option>
                    ...
                    <div class="d-flex flex-row justify-content-between mt-3">
                       ...
                       <div class="col-md-3">
                          ...
                          <select id="wheelModel" name="wheelModel" class="form-control">
                             <option selected>{{ $vehicle->wheelModel }}</option>
                       ...
                       <div class="col-md-3">
                          ...
                          <select id="bluetooth" name="bluetooth" class="form-control">
                             <option selected>{{ $vehicle->bluetooth }}</option>
                       ...
                       <div class="col-md-3">
                          ...
                          <select id="aux" name="aux" class="form-control">
                             <option selected>{{ $vehicle->aux }}</option>
                             <option>Available</option>
                             <option>Not Available</option>
                          </select>
                       </div>
                    ...
                    <div class="d-flex flex-row justify-content-between mt-3">
                       ...
                       <div class="col-md-3">
                          ...
                          <select id="childSeat" name="childSeat" class="form-control">
                             <option selected>{{ $vehicle->childSeat }}</option>
                             <option>Available</option>
                             <option>Not Available</option>
                          </select>
                       </div>
                       ...
                       <div class="col-md-3">
                          ...
                          <select id="petFriendly" name="petFriendly" class="form-control">
                             <option selected>{{ $vehicle->petFriendly }}</option>
                             <option>Available</option>
                             <option>Not Available</option>
                          </select>
                       </div>
                       ...
                       <div class="col-md-3">
                          ...
                          <select id="noSmoking" name="noSmoking" class="form-control">
                             <option selected>{{ $vehicle->noSmoking }}</option>
                             <option>Available</option>
                             <option>Not Available</option>
                          </select>
                       </div>
